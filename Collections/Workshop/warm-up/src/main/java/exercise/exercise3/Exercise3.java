...
public class Exercise3 {
    ...
    public void addElementsToSets() {
        ...
        intSet.addAll(listToAdd);
        Set<String> intSet1 = new TreeSet<String>();
        intSet1.addAll(listToAdd);
        Set<String> intSet2 = new LinkedHashSet<String>();
        ...
        intSet1.add(listToAdd.get(0));
        intSet1.add(listToAdd.get(1));
        System.out.println(intSet1);
    }
}
